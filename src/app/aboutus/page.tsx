    ...
    <section className='overflow-x-hidden'> 
            <div className='bg-[#A888B5]'>
                <div className='flex justify-center items-center flex-col'>
                  <span className='flex justify-center flex-col items-center mt-11'>
                   <h1 className='text-[80px] font-bold ssm:text-[50px] xsm:text-[50px] xsm:text-center text-white '>BotBuddy: The AI Toys </h1>
      ...
      <section className='m-10 flex justify-center items-center flex-col text-center'>
        ...
        <p>Our vision at BOTBUDDY is to revolutionize the future of learning and play by harnessing the power of 
          ...
          excellence, customer satisfaction, and social responsibility, we envision a future where every 
          child has access to engaging, effective, and enjoyable learning experiences that prepare them for
