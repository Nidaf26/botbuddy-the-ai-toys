        ...
        <div className="bg-[#A888B5]">
          <div className="flex justify-center items-center flex-col">
            <span className="flex justify-center flex-col items-center mt-11">
              <h1 className="text-[80px] font-bold ssm:text-[50px] xsm:text-[50px] xsm:text-center text-white ">
                BotBuddy: The AI Toys{" "}
              </h1>
              <p className="text-white">Get in Touch, We&apos;re Here to Help</p>
            </span>
          </div>
        </div>
      </section>
      <section className="text-gray-600 body-font relative">
        <div className="absolute inset-0 bg-gray-300">
          <iframe
            ...
            title="map"
            scrolling="no"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3616.776467367144!2d67.046767!3d24.973718800000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb340f7ab407361%3A0x14d9d3348adeb9e4!2sIqra%20University%20North%20Campus!5e0!3m2!1sen!2s!4v1736627318716!5m2!1sen!2s"
        ...
        <div className="container px-5 py-24 mx-auto flex">
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            ...
            <p className="text-xs text-gray-500 mt-3">BotBuddy: The AI Toys</p>
          </div>
        </div>
      </section>
    </main>
